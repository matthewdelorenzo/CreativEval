...
class Config:
    def __init__(self, args):
        ...
        ap.add_argument('--data_pkl_path', type=str, default="./DFG-IP-RTL.pkl", help="The path to the pickle file storing the graph dataset.")
        ...
        ap.add_argument('--test_data_path_1',    type=str, default="./testfile1", help="The path to the first verilog file you wish to test for piracy.")
        ap.add_argument('--test_data_path_2',    type=str, default="./testfile2", help="The path to the second verilog file you wish to test for piracy.")
