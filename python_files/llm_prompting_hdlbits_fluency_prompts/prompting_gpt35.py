...
for iteration, dir in enumerate(pair_dirs):
    ...
    for sample in range(10):
        ...
        result_file = write_results(prompt_text, generation, module_name + "_"+ str(iteration)+"_"+str(sample))
        for i, testbench in enumerate(testbenches):
            testbench_path = module_dir + "/" + str(dir) + "/" + testbench
            output_file = "gpt_dump2/" + module_name + "_compile" + "_" + str(i)
